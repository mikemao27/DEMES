...
class DEMESPipeline:
    ...
    def process_utterance(self, raw_text: str) -> Dict[str, Any]:
        ...
        modal_context = self._open_modal_attitude_context(logical_form)
    ...
    def _resolve_pronoun_arguments(self, logical_form, derivation_tree) -> List[Dict[str, str]]:
        ...
        is never part of the matrix clause's own arguments at all (see core/parser.py's _matrix_clause_leaves: the adjunct's content is deliberately kept out of
